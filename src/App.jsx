      ...
      path: '/', element:<Protectedroute> <AdminLayout /></Protectedroute>, children: [
        {
          path: 'admin', element: <Protectedroute> <Admin /></Protectedroute>, children: [
            ...
            {path:'mainTable/:type',element:<Protectedroute > <MainTable/> </Protectedroute > },
            {path:'addToTable/:type',element:<Protectedroute > <AddToTable/> </Protectedroute > },
            {path:'addToTable/:type/:id',element:<Protectedroute > <AddToTable/> </Protectedroute > },
            {path:'detailsProduct/:type/:id',element:<Protectedroute > <DetailsProduct/> </Protectedroute > },
