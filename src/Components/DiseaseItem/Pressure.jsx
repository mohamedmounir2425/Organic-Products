          ...
          <>
            <div className="row align-items-center">
              <div className="col-md-4">
                <img
                  src="images/diseases/pressure.png"
                  className="w-100"
                  alt="diabetes"
                />
              </div>
              <div className="col-md-8">
                <h3 className="p-3 text-truncate ">{data.type}</h3>
                ...
                <ul className=" ">
                  ...
                  <li className=" pb-1">{data.answer[3]}.</li>
                  <li className=" pb-1">{data.answer[4]}.</li>
                  <li className=" pb-1">{data.answer[5]}.</li>
                  <li className=" pb-1">{data.answer[6]}.</li>
                  <li className=" pb-1">{data.answer[7]}.</li>
                </ul>
              </div>
            </div>
