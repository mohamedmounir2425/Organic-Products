        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4">
              ...
              <ul className={`${style.list}`}>
                <NavLink className="text-decoration-none text-start ">
                  {" "}
                  <li className={`fw-bold text-muted`}>
                    <a className="text-decoration-none text-dark">
                      {" "}
                      <i className="fa-solid fa-phone"></i> : 01000000000
                    </a>{" "}
                  </li>{" "}
                </NavLink>
                <NavLink className="text-decoration-none text-start ">
              ...
              <div className="icons d-flex  ">
                <div
                  className={`${style.contain} ${style.contain1} fs-5 ms-4 me-3`}
                >
                  <a
