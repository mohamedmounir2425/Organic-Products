    ...
    <>
      <div className="boxes my-5 bg-light py-5 text-center">
        <div className="container">
          <h1 className={`${style.title} fs-2 fw-semibold mb-5`}>
            {" "}
            <i>Boxes</i>{" "}
          </h1>
          <div className="row">
            <div className="col-md-4">
              <div className={`${style.boxSmall}  p-2 shadow `}>
                <div className={`${style.imgBox} position-relative `}>
                  <img
                    src="images/Boxes/medium.png"
                    className="translate-middle card-img-top"
                    alt=""
                  />
                ...
                <div>
                  <div className="d-flex justify-content-between mt-1">
                    ...
                    <span
                      className={`${style.price} 'fs-5 fw-semibold text-end`}
                    >
                      EGP 800.00
                    </span>
                  </div>
                  <h6 className="text-muted text-start">
                    Contact us to get your box ready
                  </h6>

                  <div
                    className={`${style.cartContainer} d-flex justify-content-between my-1`}
                  >
                    <button
                      onClick={() => {
                        navigate("/contact");
                      }}
                      className={`btn btn-outline-success    btn-sm text-start ${style.button}`}
                    >
                      {" "}
