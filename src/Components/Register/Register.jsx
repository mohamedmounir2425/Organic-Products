        ...
        <div className="row">
          ...
          <div className="col-md-6 mx-auto mb-5 pt-5">
            ...
            <form onSubmit={register} className={`border py-3 px-4`}>
              <label htmlFor="first_name" className="fs-5  text-muted">
                First Name{" "}
                <span className={`${style.defaultColor} fw-bold `}>*</span>
              </label>
              <input
                type="text"
                onChange={getForm}
              ...
              <label htmlFor="last_name" className="fs-5  text-muted">
                Last Name{" "}
                <span className={`${style.defaultColor} fw-bold `}>*</span>{" "}
              </label>
              <input
              ...
              <label htmlFor="email" className="fs-5  text-muted">
                E-Mail{" "}
                <span className={`${style.defaultColor} fw-bold `}>*</span>{" "}
              </label>
              <input
              ...
              <label htmlFor="password" className="fs-5  text-muted">
                Password{" "}
                <span className={`${style.defaultColor} fw-bold `}>*</span>{" "}
              </label>
              <input
              ...
              <div className="text-end">
                <button className={`${style.button} btn btn-md`}>
                  {!loading ? (
                    "Register"
                  ) : (
