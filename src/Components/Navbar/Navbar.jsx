										...
										<ul class="dropdown-menu nav-item">
											...
											<li><NavLink className={({ isActive, isPending }) =>
												isActive
													? "nav-link text-dark"
													: "nav-link"
											} to={'products/vegetable'}>Vegetables</NavLink></li>
											<li><NavLink className={({ isActive, isPending }) =>
												isActive
													? "nav-link text-dark"
													: "nav-link"
											} to={'products/fruits'}>Fruits</NavLink></li>
											<li><NavLink className={({ isActive, isPending }) =>
												isActive
													? "nav-link text-dark"
													: "nav-link"
											} to={'products/herbals'}>Herbals</NavLink></li>
											<li><NavLink className={({ isActive, isPending }) =>
												isActive
													? "nav-link text-dark"
													: "nav-link"
											} to={'products/meat'}>Meat</NavLink></li>
											<li><NavLink className={({ isActive, isPending }) =>
												isActive
													? "nav-link text-dark"
													: "nav-link"
											} to={'products/milk'}>Milk</NavLink></li>
										</ul>
									</div>
