        ...
        <nav className="navbar d-lg-none border-bottom ">
          <div className={`container-fluid justify-content-center`}>
            <a className="navbar-brand" href="#">
              {!isLogin ? (
                <img
                  src={process.env.PUBLIC_URL + "/images/logoOrganic.png"}
                  alt="Logo"
                  width={150}
                />
              ) : (
                <div className="d-flex align-items-center">
                  {" "}
                  <div
                    className={`${style.defaultColor}  rounded-circle py-4 px-4 d-flex justify-content-center align-items-center position-relative`}
                  >
                    <span
                  ...
                  <p className=" m-0 ms-2 text-muted fw-semibold">
                    Hello {userName}
                  </p>{" "}
                </div>
              )}
          ...
          <div className={`container-fluid ${style.containerWidth}`}>
              ...
              <div className="d-flex align-items-center">
                <div className="  d-flex align-items-center justify-content-center responsiveCounter">
                  <div className="cartContainer  d-flex justify-content-center align-items-center  ">
                    ...
                    <span className={`${style.price} me-3`}>
                ...
                <div className="dropdown position-relative">
                  ...
                  >
                    ...
                    <i
                      className={`fa-solid fa-gears  fs-5 ${style.setting}`}
                    ></i>
                    {/* <i className="fa-solid fa-ellipsis ms-5 fs-5"></i> */}
                  </a>
                  <ul
                    className={`${style.drobDown} dropdown-menu dropdown-menu-lg-end pull-right  dropdown-menu-end ${style.dropSetting}`}
                  >
                    {isLogin ? (
                      <li>
                        <span
                          onClick={logOut}
                          className={`${style.logout} nav-link  text-muted`}
                        >
                          Logout
                        </span>
                      </li>
                  ...
                  <div className="dropdown">
                    ...
                    <ul className="dropdown-menu nav-item">
                      <li>
                        <NavLink
                          className={({ isActive, isPending }) =>
                            isActive ? "nav-link text-dark" : "nav-link"
                          }
                          to={"products"}
                        >
                          All Products
            ...
            <div className="d-flex align-items-center d-none d-lg-flex">
              ...
              <div className="  d-flex align-items-center justify-content-center responsiveCounter">
                <div className="cartContainer  d-flex justify-content-center align-items-center  ">
                  <div className=" position-relative d-flex  align-items-center ">
                    ...
                    <div
                      className={`position-relative d-flex  align-items-center ${style.cartIcon}`}
                      onClick={() => {
                        navigate("/cart");
                      }}
                    >
              ...
              <div className="dropdown position-relative">
                ...
                >
                  {/* <i className="fa-solid fa-gear "></i> */}
                  <i className={`fa-solid fa-gears  fs-5 ${style.setting}`}></i>
                  {/* <i className="fa-solid fa-ellipsis ms-5 fs-5"></i> */}
                </a>
                <ul
                  className={`${style.drobDown} dropdown-menu dropdown-menu-lg-end pull-right  dropdown-menu-end ${style.dropSetting} p-2`}
                >
                  {isLogin ? (
                    <li>
                      <span
