    ...
    <>
      <div className=" ">
        <div className="container py-5">
          <h2 className={` ${style.h1Color} text-muted`}>
            <span className={`${style.iconBasket}`}>
              <IoIosBasket />
            </span>{" "}
            SHOPPING CART
          </h2>
          <div className="row  pb-5 g-4">
            <div className="col-sm-9">
              {cartItem.length === 0 ? (
                <div className="alert alert-success p-5 m-5 d-flex justify-content-center align-items-center">
                  <h2>Your Cart Is Empty</h2>
                </div>
              ) : (
                <div className={`${style.tableContainer}`}>
                  <table className="table w-100 rounded text-center  ">
                        ...
                        return (
                          <>
                            ...
                            >
                              ...
                              <td
                                className={`py-3 fs-5 text-capitalize  border  `}
                              >
                                {value.name}
                              </td>
                              <td className={`py-3 fs-5  border  `}>
                              ...
                              <td className={`py-3 fs-5  border  `}>
                                <div
                                  className={`${style.wrapper}  d-flex  mx-auto `}
                                >
                                  <div
                                    className={`${style.counterNum}   text-dark d-flex justify-content-center align-items-center fw-bold   `}
                                  >
                                    {value.qty}
                                  </div>

                                  <div
                                    className={`${style.counter} border-start`}
                                  >
                                    <div
                                      onClick={() => {
            ...
            <div className="col-sm-3  shadow-sm">
              <div className="container py-3">
                <div
                  className={`${style.checkoutList} text-white rounded fw-semibold pt-5 pb-3  mb-4   `}
                >
                  <div
                  ...
                  <div className={`${style.btnContainer} text-center py-2`}>
                    <button
                      ...
                      className={`${style.btnCheckout}  p-1 px-2 text-white btn  `}
                    >
                      Checkout
                    </button>
                  </div>
                ...
                <div
                  className={`${style.infoCart} bg-light fs-6 p-1 text-muted  mb-1`}
                >
                  <HiShieldCheck className="text-dark fs-4" /> Security policy
                  (edit with Customer reassurance module)
                </div>
                <div
                  className={`${style.infoCart} bg-light fs-6 p-1 text-muted  mb-1`}
                >
                  <i className="fa-solid fa-truck fs-6 text-dark"></i> Delivery
                  policy (edit with Customer reassurance module)
                </div>
                <div
                  className={`${style.infoCart} bg-light fs-6 p-1 text-muted  mb-1`}
                >
                  <i className="fa-solid fa-arrow-right-arrow-left fs-6 text-dark "></i>{" "}
