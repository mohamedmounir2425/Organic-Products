  ...
  return (
    <div className={`${style.CheckOutForm} container my-5 pt-3  `}>
      <div className="w-75 m-auto">
        <h3
          className={`${style.MainColor} text-center  fw-bold text-capitalize my-3 mb-5`}
        >
          <i className="fa-regular fa-credit-card text-dark"></i> checkout
        </h3>
        <p className=" fs-4 fw-semibold text-muted ">
          You are purchasing for ${" "}
          <span className="text-primary fw-semibold">{totalPrice}</span> .
        </p>
