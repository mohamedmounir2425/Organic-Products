          ...
          <>
            <div className="row ">
              ...
              <div className="col-md-8">
                ...
                <ul className=" ">
                  {one.ingredient.map((step) => (
                    <li className="text-start pb-1">{step}</li>
                  ))}
                </ul>
              </div>
            </div>
            <div className="row">
              ...
              <ul className=" ">
                {one.desc.map((step) => (
                  <li className="text-start me-2">{step}</li>
                ))}
              </ul>
            </div>
            <hr />
