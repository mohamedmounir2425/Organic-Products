      ...
      <section >
        <div className="container">
          ...
          <div className={`${style.item} w-75  text-start`}>
              ...
              <h2 className={`${style.h2} text-muted fw-bold`}>Eating <span className={`${style.fruits} text-capitalize`}>{type}</span>  <br /> provides <br />health benefits  </h2>
              <h5 className={`${style.h5} mt-4`}>People who eat <span>{type}</span> as part of an overall healthy diet are likely to have a reduced risk of some diseases.</h5>
